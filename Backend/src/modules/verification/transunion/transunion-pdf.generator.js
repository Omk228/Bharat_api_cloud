...
export async function generateTransUnionReportPdf(data) {
  ...
  // Try loading PNG logo from filesystem if available
  let embeddedLogo = null;
  try {
    const logoCandidates = [
      path.join(process.cwd(), 'src/assets/transunion_cibil_logo.png'),
      path.join(process.cwd(), 'assets/transunion_cibil_logo.png'),
      path.join(process.cwd(), '../Frontend/src/assets/transunion_cibil_logo.png'),
    ];
    ...
    // Ignore and use crisp vector fallback
  }
