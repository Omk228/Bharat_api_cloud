...
async function main() {
  try {
    ...
    // 1 log from screenshot (Sat, Sep 19, 2026 afternoon):
    // 1. SNo. 11: Transunion Credit Report V5 @ Sat, Sep 19, 2026, 12:58 PM IST -> UTC 07:28:40
    ...
    const logsToInsert = [
      {
        ...
        method: 'POST',
        ist_display: 'Sat, Sep 19, 2026, 12:58 PM',
        dateUtc: '2026-09-19 07:28:40',
        client_ref: 'TU_125840_' + crypto.randomBytes(3).toString('hex').toUpperCase(),
    ...
    console.log('\n================ BATCH 32 INSERT & WALLET SETTLEMENT ================');
    ...
    console.error('Error executing batch 32 insert:', err);
    process.exit(1);
  }
}
