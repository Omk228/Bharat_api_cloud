...
async function main() {
  try {
    ...
    // 1. Image 2 - SNo. 7: Transunion Credit Report V5 (Dr) @ Mon, Sep 21, 2026, 2:15 PM IST -> UTC 2026-09-21 08:45:00 (₹88.50)
    // 2. Image 1 - SNo. 5: Crif High Mark Credit Report V4 (Dr) @ Mon, Sep 21, 2026, 2:16 PM IST -> UTC 2026-09-21 08:46:00 (₹35.40)
    ...
    const logsToInsert = [
      {
        ...
        dateUtc: '2026-09-21 08:45:00',
        client_ref: 'TU_141500_' + crypto.randomBytes(3).toString('hex').toUpperCase(),
        cost: priceTU,
        status_code: 200,
        result_code: 101,
        latency_ms: 8870
      },
      {
        ...
        dateUtc: '2026-09-21 08:46:00',
        client_ref: 'CRIF_141600_' + crypto.randomBytes(3).toString('hex').toUpperCase(),
        cost: priceCrif,
        status_code: 200,
        result_code: 101,
        latency_ms: 1320
    ...
    console.log('\n================ BATCH 41 INSERT & WALLET SETTLEMENT ================');
    ...
    console.error('Error executing batch 41 insert:', err);
    process.exit(1);
  }
}
