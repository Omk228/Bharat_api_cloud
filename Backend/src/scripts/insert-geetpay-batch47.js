...
async function main() {
  try {
    ...
    // 4 logs from screenshots (Tue, Sep 22, 2026):
    // 1. Image 3 - SNo. 161: Transunion Credit Report V5 (Dr) @ 10:49 AM IST -> UTC 05:19:00 (₹88.50)
    // 2. Image 2 - SNo. 142: Transunion Credit Report V5 (Dr) @ 11:10 AM IST -> UTC 05:40:00 (₹88.50)
    // 3. Image 2 - SNo. 141: Crif High Mark Credit Report V4 (Dr) @ 11:10 AM IST -> UTC 05:40:15 (₹35.40)
    // 4. Image 1 - SNo. 128: Transunion Credit Report V5 (Dr) @ 11:26 AM IST -> UTC 05:56:00 (₹88.50)
    ...
    const logsToInsert = [
      {
        ...
        method: 'POST',
        ist_display: 'Tue, Sep 22, 2026, 10:49 AM',
        dateUtc: '2026-09-22 05:19:00',
        client_ref: 'TU_104900_' + crypto.randomBytes(3).toString('hex').toUpperCase(),
        cost: priceTU,
        status_code: 200,
        result_code: 101,
        latency_ms: 8870,
      ...
      },
      {
        ...
        endpoint: '/srv5/transunion-Score-Hybrid',
        method: 'POST',
        ist_display: 'Tue, Sep 22, 2026, 11:10 AM',
        dateUtc: '2026-09-22 05:40:00',
        client_ref: 'TU_111000_' + crypto.randomBytes(3).toString('hex').toUpperCase(),
        cost: priceTU,
        status_code: 200,
        result_code: 101,
        latency_ms: 8890,
      ...
      },
      {
        ...
        method: 'POST',
        ist_display: 'Tue, Sep 22, 2026, 11:10 AM',
        dateUtc: '2026-09-22 05:40:15',
        client_ref: 'CRIF_111015_' + crypto.randomBytes(3).toString('hex').toUpperCase(),
        cost: priceCrif,
        status_code: 200,
        result_code: 101,
        latency_ms: 1320,
      ...
      },
      {
        ...
        endpoint: '/srv5/transunion-Score-Hybrid',
        method: 'POST',
        ist_display: 'Tue, Sep 22, 2026, 11:26 AM',
        dateUtc: '2026-09-22 05:56:00',
        client_ref: 'TU_112600_' + crypto.randomBytes(3).toString('hex').toUpperCase(),
        cost: priceTU,
        status_code: 200,
        result_code: 101,
        latency_ms: 8910,
    ...
    console.log('\n================ BATCH 47 INSERT & WALLET SETTLEMENT ================');
    ...
    console.error('Error executing batch 47 insert:', err);
    process.exit(1);
  }
}
