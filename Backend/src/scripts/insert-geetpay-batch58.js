...
async function main() {
  try {
    ...
    // Logs from user screenshot:
    // 1. SNo. 16: Transunion Credit Report V5 (Dr) @ Thu, Sep 24, 2026, 10:36 AM IST -> UTC 2026-09-24 05:06:00
    // 2. SNo. 15: statement-analyzer (Dr) @ Thu, Sep 24, 2026, 10:44 AM IST -> UTC 2026-09-24 05:14:00
    ...
    const logsToInsert = [
      {
        ...
        method: 'POST',
        ist_display: 'Thu, Sep 24, 2026, 10:36 AM',
        dateUtc: '2026-09-24 05:06:00',
        client_ref: 'TU_103600_' + crypto.randomBytes(3).toString('hex').toUpperCase(),
        cost: priceTU,
        status_code: 200,
        result_code: 101,
        latency_ms: 8850,
      ...
      },
      {
        ...
        method: 'POST',
        ist_display: 'Thu, Sep 24, 2026, 10:44 AM',
        dateUtc: '2026-09-24 05:14:00',
        client_ref: 'STMT_104400_' + crypto.randomBytes(3).toString('hex').toUpperCase(),
        cost: priceStmt,
        status_code: 200,
        result_code: 101,
        latency_ms: 1420,
    ...
    console.log('\n================ BATCH 58 INSERT & WALLET SETTLEMENT ================');
    ...
    console.error('Error executing batch 58 insert:', err);
    process.exit(1);
  }
}
