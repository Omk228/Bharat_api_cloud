...
async function main() {
  try {
    ...
    // Logs to insert from user screenshot (filtered to Transunion, CRIF High Mark, Statement Analyzer):
    // 1. SNo. 1: Transunion Credit Report V5 (Dr) @ Thu, Sep 24, 2026, 4:45 PM IST -> UTC 2026-09-24 11:15:00
    // 2. SNo. 4: Transunion Credit Report V5 (Dr) @ Thu, Sep 24, 2026, 4:38 PM IST -> UTC 2026-09-24 11:08:00
    // 3. SNo. 6: Transunion Credit Report V5 (Cr / Reversal) @ Thu, Sep 24, 2026, 4:31 PM IST -> UTC 2026-09-24 11:01:00
    ...
    const logsToInsert = [
      {
        ...
        method: 'POST',
        ist_display: 'Thu, Sep 24, 2026, 4:45 PM',
        dateUtc: '2026-09-24 11:15:00',
        client_ref: 'TU_164500_' + crypto.randomBytes(3).toString('hex').toUpperCase(),
        cost: priceTU,
        status_code: 200,
        result_code: 101,
        latency_ms: 8850,
      ...
      },
      {
        ...
        endpoint: '/srv5/transunion-Score-Hybrid',
        method: 'POST',
        ist_display: 'Thu, Sep 24, 2026, 4:38 PM',
        dateUtc: '2026-09-24 11:08:00',
        client_ref: 'TU_163800_' + crypto.randomBytes(3).toString('hex').toUpperCase(),
        cost: priceTU,
        status_code: 200,
        result_code: 101,
        latency_ms: 8820,
      ...
      },
      {
        ...
        endpoint: '/srv5/transunion-Score-Hybrid',
        method: 'POST',
        ist_display: 'Thu, Sep 24, 2026, 4:31 PM',
        dateUtc: '2026-09-24 11:01:00',
        client_ref: 'TU_163100_' + crypto.randomBytes(3).toString('hex').toUpperCase(),
        cost: 0.00,
        status_code: 500,
        result_code: 102,
        latency_ms: 10150,
    ...
    console.log('\n================ BATCH 63 INSERT & WALLET SETTLEMENT ================');
    ...
    console.error('Error executing batch 63 insert:', err);
    process.exit(1);
  }
}
