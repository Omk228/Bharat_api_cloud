...
async function main() {
  try {
    ...
    // 1. Row 6: Transunion Credit Report V5 @ 2:53 PM IST -> UTC 2026-09-25 09:23:00
    // 2. Row 2: Transunion Credit Report V5 @ 2:54 PM IST -> UTC 2026-09-25 09:24:00
    ...
    const logsToInsert = [
      {
        ...
        method: 'POST',
        ist_display: 'Fri, Sep 25, 2026, 2:53 PM',
        dateUtc: '2026-09-25 09:23:00',
        client_ref: 'TU_145300_' + crypto.randomBytes(3).toString('hex').toUpperCase(),
        cost: priceTU,
        status_code: 200,
        result_code: 101,
        latency_ms: 8820,
      ...
      },
      {
        ...
        endpoint: '/srv5/transunion-Score-Hybrid',
        method: 'POST',
        ist_display: 'Fri, Sep 25, 2026, 2:54 PM',
        dateUtc: '2026-09-25 09:24:00',
        client_ref: 'TU_145400_' + crypto.randomBytes(3).toString('hex').toUpperCase(),
        cost: priceTU,
        status_code: 200,
        result_code: 101,
        latency_ms: 8760,
    ...
    console.log('\n================ BATCH 69 INSERT & WALLET SETTLEMENT ================');
    ...
    console.error('Error executing batch 69 insert:', err);
    process.exit(1);
  }
}
