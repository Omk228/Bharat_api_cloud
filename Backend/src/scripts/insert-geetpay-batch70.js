...
async function main() {
  try {
    ...
    // 1. Row 1: Transunion Credit Report V5 @ 3:42 PM IST -> UTC 2026-09-25 10:12:00
    ...
    const logsToInsert = [
      {
        ...
        method: 'POST',
        ist_display: 'Fri, Sep 25, 2026, 3:42 PM',
        dateUtc: '2026-09-25 10:12:00',
    ...
    console.log('\n================ BATCH 70 INSERT & WALLET SETTLEMENT ================');
    ...
    console.error('Error executing batch 70 insert:', err);
    process.exit(1);
  }
}
