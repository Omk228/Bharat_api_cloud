...
export const apiClient = {
  ...
  async verifyWorkEmail(data: {
    ...
    const res = await fetch(`${host}/api/v1/verify/work-email`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        'X-Api-Id': effectiveApiId,
  ...
  async verifyWorkEmailPlus(data: {
    email: string;
    client_ref_num?: string | undefined;
    api_id?: string | undefined;
    api_key?: string | undefined;
    ...
    const res = await fetch(`${host}/api/v1/verify/work-email-plus`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        'X-Api-Id': effectiveApiId,
  ...
  async verifyBankAccountV2(data: {
    ...
    const res = await fetch(`${host}/api/v1/bank/account-validation`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        'X-Api-Id': effectiveApiId,
  ...
  async checkMobileOperator(data: {
    mobile_number: string;
    client_ref_num?: string | undefined;
    api_id?: string | undefined;
    api_key?: string | undefined;
    ...
    const res = await fetch(`${host}/api/v1/verify/operator-circle`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        'X-Api-Id': effectiveApiId,
