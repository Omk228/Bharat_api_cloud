...
-- Dumping data for table `catalog` (38 rows)
INSERT INTO `catalog` (`id`, `service_name`, `category`, `method`, `endpoint_path`, `upstream_provider`, `current_price`, `status`, `latency_p95`, `uptime_24h`, `description`, `created_at`, `updated_at`) VALUES ('api_aa_consent', 'Create Consent Request', 'Account Aggregator', 'POST', '/aa/consent', 'RBI Account Aggregator', '4.00', 'Disabled', 62, '99.93', 'Creates an RBI Account Aggregator consent request and returns the redirect URL for the user journey.', '2026-09-10 08:07:09', '2026-09-10 08:07:09');
INSERT INTO `catalog` (`id`, `service_name`, `category`, `method`, `endpoint_path`, `upstream_provider`, `current_price`, `status`, `latency_p95`, `uptime_24h`, `description`, `created_at`, `updated_at`) VALUES ('api_aa_consent_status', 'Consent Status', 'Account Aggregator', 'GET', '/aa/consent/{consent_handle}', 'RBI AA Hub', '0.50', 'Disabled', 41, '99.90', 'Returns the current state of a consent handle and the linked accounts once approved.', '2026-09-10 08:07:09', '2026-09-10 08:07:09');
INSERT INTO `catalog` (`id`, `service_name`, `category`, `method`, `endpoint_path`, `upstream_provider`, `current_price`, `status`, `latency_p95`, `uptime_24h`, `description`, `created_at`, `updated_at`) VALUES ('api_aa_fetch_fi', 'Fetch Financial Data (AA)', 'Account Aggregator', 'POST', '/aa/fi/fetch', 'Financial Info Provider', '6.00', 'Disabled', 36, '99.94', 'Requests a financial information session for an active consent and returns decrypted transaction data.', '2026-09-10 08:07:09', '2026-09-10 08:07:09');
INSERT INTO `catalog` (`id`, `service_name`, `category`, `method`, `endpoint_path`, `upstream_provider`, `current_price`, `status`, `latency_p95`, `uptime_24h`, `description`, `created_at`, `updated_at`) VALUES ('api_aadhaar_otp', 'Aadhaar OTP (DigiLocker)', 'KYC & Verification', 'POST', '/verify/aadhaar/otp', 'UIDAI', '2.20', 'Disabled', 75, '99.85', 'Step 1 of consent-based Aadhaar verification: sends an OTP to the Aadhaar-linked mobile number and returns a transaction id.', '2026-09-10 08:07:09', '2026-09-10 08:07:09');
INSERT INTO `catalog` (`id`, `service_name`, `category`, `method`, `endpoint_path`, `upstream_provider`, `current_price`, `status`, `latency_p95`, `uptime_24h`, `description`, `created_at`, `updated_at`) VALUES ('api_aadhaar_otp_confirm', 'Confirm Aadhaar OTP', 'KYC & Verification', 'POST', '/verify/aadhaar/otp/confirm', 'Bharat API Gateway', '1.00', 'Disabled', 62, '99.96', 'Step 2 of Aadhaar verification: exchanges the OTP for the verified demographic KYC record and photo.', '2026-09-10 08:07:09', '2026-09-10 08:07:09');
INSERT INTO `catalog` (`id`, `service_name`, `category`, `method`, `endpoint_path`, `upstream_provider`, `current_price`, `status`, `latency_p95`, `uptime_24h`, `description`, `created_at`, `updated_at`) VALUES ('api_aadhaar_without_otp', 'Aadhar Fetch (Without OTP)', 'KYC & Verification', 'POST', '/srv3/verification/aadhar', 'UIDAI / Bharat API Gateway', '2.00', 'Active', 1200, '99.99', 'Instant Aadhaar number validation and demographic verification without requiring mobile OTP. Returns Aadhaar validity, age band, gender, state and masked mobile digits.', '2026-09-10 08:07:09', '2026-09-10 08:07:09');
INSERT INTO `catalog` (`id`, `service_name`, `category`, `method`, `endpoint_path`, `upstream_provider`, `current_price`, `status`, `latency_p95`, `uptime_24h`, `description`, `created_at`, `updated_at`) VALUES ('api_aml_screening', 'AML / PEP Screening', 'KYC & Verification', 'POST', '/kyc/aml-screen', 'Global AML Watchlist', '4.50', 'Disabled', 40, '99.97', 'Screens a name against global sanctions, PEP and adverse-media watchlists with fuzzy matching.', '2026-09-10 08:07:09', '2026-09-10 08:07:09');
INSERT INTO `catalog` (`id`, `service_name`, `category`, `method`, `endpoint_path`, `upstream_provider`, `current_price`, `status`, `latency_p95`, `uptime_24h`, `description`, `created_at`, `updated_at`) VALUES ('api_bank_penny_drop', 'Bank Verification (Penny Drop)', 'Banking & IFSC', 'POST', '/bank/verify', 'NPCI IMPS', '1.80', 'Disabled', 47, '99.95', 'Credits ₹1 to the account to confirm it is live and returns the beneficiary name registered with the bank.', '2026-09-10 08:07:09', '2026-09-10 08:07:09');
INSERT INTO `catalog` (`id`, `service_name`, `category`, `method`, `endpoint_path`, `upstream_provider`, `current_price`, `status`, `latency_p95`, `uptime_24h`, `description`, `created_at`, `updated_at`) VALUES ('api_bank_penny_less', 'Bank Verification Penny Less V2', 'Banking & IFSC', 'POST', '/bank/verify/penny-less', 'IDFC Bank API / NPCI', '2.00', 'Active', 1500, '99.89', 'Instant bank account validation and beneficiary name verification without performing a financial penny deposit. Validates bank account status, registered name, and IFSC details directly.', '2026-09-10 08:07:09', '2026-09-10 08:07:09');
INSERT INTO `catalog` (`id`, `service_name`, `category`, `method`, `endpoint_path`, `upstream_provider`, `current_price`, `status`, `latency_p95`, `uptime_24h`, `description`, `created_at`, `updated_at`) VALUES ('api_bank_reverse_penny', 'Reverse Penny Drop', 'Banking & IFSC', 'POST', '/bank/reverse-penny-drop', 'NPCI UPI Collect', '0.75', 'Disabled', 71, '99.92', 'Creates a collect request the user pays ₹1 against, verifying account ownership without a name match.', '2026-09-10 08:07:09', '2026-09-10 08:07:09');
INSERT INTO `catalog` (`id`, `service_name`, `category`, `method`, `endpoint_path`, `upstream_provider`, `current_price`, `status`, `latency_p95`, `uptime_24h`, `description`, `created_at`, `updated_at`) VALUES ('api_bank_statement', 'Bank Statement Analysis', 'Banking & IFSC', 'POST', '/bank/statement/analyse', 'Financial Analytics Parser', '15.00', 'Disabled', 350, '99.70', 'Parses a PDF bank statement and returns income, obligations, bounce count and a cash-flow summary.', '2026-09-10 08:07:09', '2026-09-10 08:07:09');
INSERT INTO `catalog` (`id`, `service_name`, `category`, `method`, `endpoint_path`, `upstream_provider`, `current_price`, `status`, `latency_p95`, `uptime_24h`, `description`, `created_at`, `updated_at`) VALUES ('api_bank_validation', 'Bank Account Validation', 'Banking & IFSC', 'POST', '/api/v1/validate_bank_account', 'NPCI / IMPS Rail', '2.00', 'Active', 2100, '99.91', 'Validates Indian bank account number and IFSC code using asynchronous penny-less bank verification engine.', '2026-09-10 08:07:09', '2026-09-10 08:07:09');
INSERT INTO `catalog` (`id`, `service_name`, `category`, `method`, `endpoint_path`, `upstream_provider`, `current_price`, `status`, `latency_p95`, `uptime_24h`, `description`, `created_at`, `updated_at`) VALUES ('api_cat_01', 'IFSC Lookup', 'Banking & IFSC', 'GET', '/ifsc', 'RBI IFSC Directory', '1.00', 'Active', 120, '99.99', 'Returns branch details, MICR, address, and supported payment rails (NEFT, RTGS, IMPS, UPI) for an IFSC code.', '2026-09-10 08:07:09', '2026-09-10 08:07:09');
INSERT INTO `catalog` (`id`, `service_name`, `category`, `method`, `endpoint_path`, `upstream_provider`, `current_price`, `status`, `latency_p95`, `uptime_24h`, `description`, `created_at`, `updated_at`) VALUES ('api_cat_03', 'Verify PAN', 'KYC & Verification', 'POST', '/srv2/validation/pan', 'Income Tax Department (NSDL/ITD)', '2.00', 'Active', 1400, '99.95', 'Validates a Permanent Account Number against the Income Tax Department database, with optional name and date-of-birth matching.', '2026-09-10 08:07:09', '2026-09-10 08:07:09');
INSERT INTO `catalog` (`id`, `service_name`, `category`, `method`, `endpoint_path`, `upstream_provider`, `current_price`, `status`, `latency_p95`, `uptime_24h`, `description`, `created_at`, `updated_at`) VALUES ('api_create_payout', 'Create Payout', 'Payments & Collections', 'POST', '/payouts', 'Banking Rail', '3.00', 'Disabled', 110, '99.90', 'Sends money to a bank account or UPI handle over IMPS, NEFT, RTGS or UPI with idempotency support.', '2026-09-10 08:07:09', '2026-09-10 08:07:09');
INSERT INTO `catalog` (`id`, `service_name`, `category`, `method`, `endpoint_path`, `upstream_provider`, `current_price`, `status`, `latency_p95`, `uptime_24h`, `description`, `created_at`, `updated_at`) VALUES ('api_create_va', 'Create Virtual Account', 'Payments & Collections', 'POST', '/virtual-accounts', 'YES Bank Virtual Rails', '2.00', 'Disabled', 75, '99.90', 'Issues a dedicated virtual account and UPI handle so inbound collections auto-reconcile to one customer.', '2026-09-10 08:07:09', '2026-09-10 08:07:09');
INSERT INTO `catalog` (`id`, `service_name`, `category`, `method`, `endpoint_path`, `upstream_provider`, `current_price`, `status`, `latency_p95`, `uptime_24h`, `description`, `created_at`, `updated_at`) VALUES ('api_digilocker_digital_kyc', 'Digi Locker Digital KYC', 'KYC & Verification', 'POST', '/srv2/validation/digilocker-digital-kyc', 'DigiLocker / MeitY', '2.00', 'Active', 800, '99.92', 'Generate instant DigiLocker Digital KYC OAuth token and consent session URL for paperless user identity verification.', '2026-09-10 08:07:09', '2026-09-10 08:07:09');
INSERT INTO `catalog` (`id`, `service_name`, `category`, `method`, `endpoint_path`, `upstream_provider`, `current_price`, `status`, `latency_p95`, `uptime_24h`, `description`, `created_at`, `updated_at`) VALUES ('api_document_ocr', 'Document OCR', 'KYC & Verification', 'POST', '/kyc/ocr', 'AI OCR Vision Engine', '3.50', 'Disabled', 120, '99.80', 'Extracts structured fields from an ID document image or PDF and flags tampering signals.', '2026-09-10 08:07:09', '2026-09-10 08:07:09');
INSERT INTO `catalog` (`id`, `service_name`, `category`, `method`, `endpoint_path`, `upstream_provider`, `current_price`, `status`, `latency_p95`, `uptime_24h`, `description`, `created_at`, `updated_at`) VALUES ('api_domain_age', 'Domain Age Verification API', 'KYC & Verification', 'POST', '/dosvak/domain-age', 'WHOIS & Registry Network', '2.00', 'Active', 25, '99.99', 'Calculates the exact domain registration age, creation date, and lifespan in days and years using authoritative registries and smart caching.', '2026-09-10 08:07:09', '2026-09-10 08:07:09');
INSERT INTO `catalog` (`id`, `service_name`, `category`, `method`, `endpoint_path`, `upstream_provider`, `current_price`, `status`, `latency_p95`, `uptime_24h`, `description`, `created_at`, `updated_at`) VALUES ('api_face_liveness', 'Face Match & Liveness', 'KYC & Verification', 'POST', '/kyc/face-match', 'Biometric AI Engine', '3.00', 'Disabled', 90, '99.88', 'Compares a selfie against an ID photo and returns a passive liveness score to block spoof attempts.', '2026-09-10 08:07:09', '2026-09-10 08:07:09');
INSERT INTO `catalog` (`id`, `service_name`, `category`, `method`, `endpoint_path`, `upstream_provider`, `current_price`, `status`, `latency_p95`, `uptime_24h`, `description`, `created_at`, `updated_at`) VALUES ('api_mobile_name_finder', 'Mobile To Name Finder', 'KYC & Verification', 'POST', '/srv2/mobile-name-finder', 'Telecom Circle Registry', '5.00', 'Active', 1000, '99.88', 'Instant name lookup and telecom subscriber verification. Fetch the registered subscriber legal name and telecom circle details directly from a 10-digit mobile number.', '2026-09-10 08:07:09', '2026-09-10 08:07:09');
INSERT INTO `catalog` (`id`, `service_name`, `category`, `method`, `endpoint_path`, `upstream_provider`, `current_price`, `status`, `latency_p95`, `uptime_24h`, `description`, `created_at`, `updated_at`) VALUES ('api_mobile_to_bank_advance', 'Mobile To Bank Advance', 'Banking & IFSC', 'POST', '/srv3/mobile-to-bank/advance', 'IDSpay Gateway', '2.00', 'Active', 400, '99.90', 'Advanced mobile-to-bank account lookup and verification powered by IDSpay. Retrieve verified bank accounts and beneficiary details linked with an Indian mobile number.', '2026-09-10 08:07:09', '2026-09-10 08:07:09');
INSERT INTO `catalog` (`id`, `service_name`, `category`, `method`, `endpoint_path`, `upstream_provider`, `current_price`, `status`, `latency_p95`, `uptime_24h`, `description`, `created_at`, `updated_at`) VALUES ('api_mobile_to_prefill', 'Mobile to Prefill', 'KYC & Verification', 'POST', '/srv4/credit-report/prefill', 'Telecom & Credit Bureau', '2.00', 'Active', 1100, '99.90', 'Fetch verified identity profile, PAN, Date of Birth, age, gender, email, and registered addresses pre-filled directly from user registered mobile number and name.', '2026-09-10 08:07:09', '2026-09-10 08:07:09');
INSERT INTO `catalog` (`id`, `service_name`, `category`, `method`, `endpoint_path`, `upstream_provider`, `current_price`, `status`, `latency_p95`, `uptime_24h`, `description`, `created_at`, `updated_at`) VALUES ('api_mobile_to_uan', 'Mobile to UAN V2', 'KYC & Verification', 'POST', '/api/v1/srv3/uan-mobile', 'EPFO India', '5.00', 'Active', 400, '99.92', 'Resolve Universal Account Number (UAN), active EPFO membership, establishment details, and employment history from mobile number.', '2026-09-10 08:07:09', '2026-09-10 08:07:09');
INSERT INTO `catalog` (`id`, `service_name`, `category`, `method`, `endpoint_path`, `upstream_provider`, `current_price`, `status`, `latency_p95`, `uptime_24h`, `description`, `created_at`, `updated_at`) VALUES ('api_mobile_to_upi', 'Mobile to UPI Lookup Advance', 'Payments & Collections', 'POST', '/srv2/mobile-upi-lookup/enhanced', 'NPCI UPI Gateway', '2.00', 'Active', 250, '99.95', 'Real-time Mobile to UPI ID (VPA) and bank-registered account holder name verification powered by NPCI gateway.', '2026-09-10 08:07:09', '2026-09-10 08:07:09');
INSERT INTO `catalog` (`id`, `service_name`, `category`, `method`, `endpoint_path`, `upstream_provider`, `current_price`, `status`, `latency_p95`, `uptime_24h`, `description`, `created_at`, `updated_at`) VALUES ('api_payout_status', 'Payout Status', 'Payments & Collections', 'GET', '/payouts/{payout_id}', 'Banking Rail', '0.20', 'Disabled', 35, '99.95', 'Returns the current state of a payout including the bank UTR once settled.', '2026-09-10 08:07:09', '2026-09-10 08:07:09');
INSERT INTO `catalog` (`id`, `service_name`, `category`, `method`, `endpoint_path`, `upstream_provider`, `current_price`, `status`, `latency_p95`, `uptime_24h`, `description`, `created_at`, `updated_at`) VALUES ('api_refund_payout', 'Reverse a Payout', 'Payments & Collections', 'POST', '/payouts/{payout_id}/reverse', 'Banking Rail', '1.00', 'Disabled', 80, '99.85', 'Requests reversal of a payout that failed at the beneficiary bank and returns the reversal reference.', '2026-09-10 08:07:09', '2026-09-10 08:07:09');
INSERT INTO `catalog` (`id`, `service_name`, `category`, `method`, `endpoint_path`, `upstream_provider`, `current_price`, `status`, `latency_p95`, `uptime_24h`, `description`, `created_at`, `updated_at`) VALUES ('api_requester_ip_lookup', 'Requester IP Lookup', 'KYC & Verification', 'GET', '/check', 'IPStack & GeoIP Network', '0.15', 'Active', 700, '99.98', 'Instant geolocation and network intelligence for incoming or specified IP addresses. Returns city, region, coordinates, country flag, calling code, and connection profile.', '2026-09-10 08:07:09', '2026-09-10 08:07:09');
INSERT INTO `catalog` (`id`, `service_name`, `category`, `method`, `endpoint_path`, `upstream_provider`, `current_price`, `status`, `latency_p95`, `uptime_24h`, `description`, `created_at`, `updated_at`) VALUES ('api_reverse_geocoding', 'Reverse Geocoding', 'KYC & Verification', 'GET', '/reverse', 'OpenStreetMap / Bharat Geocoding Engine', '0.20', 'Active', 320, '99.94', 'Resolve GPS coordinates (latitude & longitude) into full geographic address, road, landmark, city, state, postal code, and administrative boundaries using Bharat API Geocoding Engine.', '2026-09-10 08:07:09', '2026-09-10 08:07:09');
INSERT INTO `catalog` (`id`, `service_name`, `category`, `method`, `endpoint_path`, `upstream_provider`, `current_price`, `status`, `latency_p95`, `uptime_24h`, `description`, `created_at`, `updated_at`) VALUES ('api_uan_to_employment', 'UAN to Employment History V2', 'KYC & Verification', 'POST', '/api/v1/srv3/uan-direct', 'EPFO India', '5.00', 'Active', 400, '99.93', 'Directly verify EPFO Universal Account Number (UAN) to fetch complete employment history, establishment details, joining/exit dates, and employee identity profile without requiring OTP.', '2026-09-10 08:07:09', '2026-09-10 08:07:09');
INSERT INTO `catalog` (`id`, `service_name`, `category`, `method`, `endpoint_path`, `upstream_provider`, `current_price`, `status`, `latency_p95`, `uptime_24h`, `description`, `created_at`, `updated_at`) VALUES ('api_upi_vpa', 'Validate UPI VPA', 'Banking & IFSC', 'POST', '/bank/upi/validate', 'NPCI UPI PSP', '0.50', 'Disabled', 50, '99.95', 'Checks whether a UPI ID is active and returns the registered payee name.', '2026-09-10 08:07:09', '2026-09-10 08:07:09');
INSERT INTO `catalog` (`id`, `service_name`, `category`, `method`, `endpoint_path`, `upstream_provider`, `current_price`, `status`, `latency_p95`, `uptime_24h`, `description`, `created_at`, `updated_at`) VALUES ('api_va_transactions', 'VA Transactions', 'Payments & Collections', 'GET', '/virtual-accounts/{va_id}/transactions', 'Banking Rail', '0.25', 'Disabled', 45, '99.95', 'Lists credits received on a virtual account with payer details for reconciliation.', '2026-09-10 08:07:09', '2026-09-10 08:07:09');
INSERT INTO `catalog` (`id`, `service_name`, `category`, `method`, `endpoint_path`, `upstream_provider`, `current_price`, `status`, `latency_p95`, `uptime_24h`, `description`, `created_at`, `updated_at`) VALUES ('api_verify_cin', 'Verify CIN (MCA)', 'KYC & Verification', 'POST', '/verify/cin', 'MCA Portal', '3.00', 'Disabled', 80, '99.85', 'Looks up company master data from the MCA registry, including directors, status and paid-up capital.', '2026-09-10 08:07:09', '2026-09-10 08:07:09');
INSERT INTO `catalog` (`id`, `service_name`, `category`, `method`, `endpoint_path`, `upstream_provider`, `current_price`, `status`, `latency_p95`, `uptime_24h`, `description`, `created_at`, `updated_at`) VALUES ('api_verify_dl', 'Verify Driving Licence', 'KYC & Verification', 'POST', '/verify/driving-licence', 'Sarathi / Parivahan', '2.00', 'Disabled', 70, '99.85', 'Validates a driving licence number against the Sarathi/Parivahan database with vehicle class details.', '2026-09-10 08:07:09', '2026-09-10 08:07:09');
INSERT INTO `catalog` (`id`, `service_name`, `category`, `method`, `endpoint_path`, `upstream_provider`, `current_price`, `status`, `latency_p95`, `uptime_24h`, `description`, `created_at`, `updated_at`) VALUES ('api_verify_gstin', 'Verify GSTIN', 'KYC & Verification', 'POST', '/verify/gstin', 'GSTN Portal', '2.50', 'Disabled', 55, '99.90', 'Fetches GST registration details, filing status and the registered business address for a GSTIN.', '2026-09-10 08:07:09', '2026-09-10 08:07:09');
INSERT INTO `catalog` (`id`, `service_name`, `category`, `method`, `endpoint_path`, `upstream_provider`, `current_price`, `status`, `latency_p95`, `uptime_24h`, `description`, `created_at`, `updated_at`) VALUES ('api_verify_pan_plus', 'Pan Details Plus', 'KYC & Verification', 'POST', '/srv2/validation/pan/plus', 'Income Tax Department (ITD)', '2.00', 'Active', 1800, '99.90', 'Comprehensive Permanent Account Number verification with demographic details, Aadhaar seeding status, allotment date, and corporate/salaried profile.', '2026-09-10 08:07:09', '2026-09-10 08:07:09');
INSERT INTO `catalog` (`id`, `service_name`, `category`, `method`, `endpoint_path`, `upstream_provider`, `current_price`, `status`, `latency_p95`, `uptime_24h`, `description`, `created_at`, `updated_at`) VALUES ('api_verify_passport', 'Verify Passport', 'KYC & Verification', 'POST', '/verify/passport', 'Passport Seva Kendra', '4.00', 'Disabled', 85, '99.80', 'Validates a passport file number and date of birth against the Passport Seva records.', '2026-09-10 08:07:09', '2026-09-10 08:07:09');
INSERT INTO `catalog` (`id`, `service_name`, `category`, `method`, `endpoint_path`, `upstream_provider`, `current_price`, `status`, `latency_p95`, `uptime_24h`, `description`, `created_at`, `updated_at`) VALUES ('api_verify_voter_id', 'Verify Voter ID', 'KYC & Verification', 'POST', '/verify/voter-id', 'ECI Roll', '2.00', 'Disabled', 65, '99.90', 'Validates an EPIC number against the Election Commission roll and returns the elector record.', '2026-09-10 08:07:09', '2026-09-10 08:07:09');
